...
public class FacebookClient extends SocialMediaClientBase {
    ...
    FacebookJsonResponse doDeserialize(String jsonString, String url) throws ServiceUnavailableException {
        ...
        if (jsonString != null && jsonString.contains("Service temporarily unavailable")) {
            // Sample error JSON:
            // {"error_code":2,"error_msg":"Service temporarily
            // unavailable","request_args":[{"key":"v","value":"1.0"},{"key":"method","value":"links.getStats"},{"key":"format","value":"json"},{"key":"urls","value":"http:\/\/mydomain.com\/somepage.jsp?key=1234"},{"key":"list","value":"ob"},{"key":"lt","value":"site"},{"key":"ut","value":"2"}]}
